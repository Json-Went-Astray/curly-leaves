<template>
    <div class="library-card p-3 border-1 rounded-2 cl-bg-white cl-border border-2 col-10 position-fixed">
        <div class="position-absolute d-flex bottom-100">
            ...
            <div class="cl-bg-white p-2 px-3 cl-border border-2 library-cat" :class="{ 'library-cat-active': card === 2 }"
                @click="card = 2">
                <span>Wysyłanie</span>
            </div>
        </div>
        ...
        <div class="row" v-if="card == 1" style="min-height: 75vh; max-height: 75vh;">
            <div class="col-3 border-end p-5 flex-column">
                ...
                <div class="form-check">
                    <input type="radio" class="form-check-input" id="radio1" name="optradio" value="option1" checked>Zdjęcia
                </div>
                <div class="form-check mb-3">
                    <input type="radio" class="form-check-input" id="radio2" name="optradio" value="option2">Filmy / Gify /
                    Animacje
                </div>
            ...
            <div class="col-6 border-end" style="max-hei  overflow-y: scroll; max-width: 50%; align-items: start;">
                <div class="col-12  d-flex flex-wrap" style="max-height: 75vh; overflow-y: auto;">
                    <div class="col-2 text-center img-container my-3" v-for="item in mediaData.getMedia">
                        <img class="img-library-thumbnail rounded cursor-pointer"
                            @click="chooseMedia(item.source)"
                            :title="item.title"
                ...
                <div class="mb-3">
                    <div ref="previewFullScreen">
                        <img class="w-100 border border-2" :style="{
                            ...
                            height: isFullscreen ? 'auto' : '373px',
                    ...
                    <div class="position-absolute end-0 bottom-0" v-if="choosenMedia != null">
                        <div v-if="deleteConfirm == 0" class="sub-btn" style="background-color: lightcoral;" @click="deleteConfirm = 1">
                            <span>&nbsp;</span>
                        ...
                        <div v-if="deleteConfirm == 1" class="sub-btn" style="background-color: lightcoral;" @click="doDeleteMedia()">
        ...
        <div class="row" v-if="card == 2" style="min-height: 75vh; max-height: 75vh;">
            ...
            <div class="col-6 border-end d-flex flex-column align-items-center justify-content-center"
                ...
                <button v-else class="btn btn-success col-6 py-3 mt-3 mb-2" @click="openFileInput">Prześlij plik</button>
            ...
            <div class="col-6 p-5 flex-column">
                ...
                <div>
                    ...
                    <span v-else-if="!imgAlt && isSelected" class="text-warning">Zdjęcie nie ma opisu alternatywnego</span>
                    <span v-else>&nbsp;</span>
                </div>
    ...
    <div class="lightbox w-100 h-100 position-fixed">
